...
public class DashboardController implements MainViewController.ConfigurableController {
    ...
    public void setConfig(AppConfig config) {
        ...
        Platform.runLater(() -> {
            ...
            // Update system info in background thread to avoid blocking UI with GPU initialization
            new Thread(() -> updateSystemInfo()).start();
        });
    }
    ...
    private void updateMetricsDisplay() {
        Platform.runLater(() -> {
            ...
            if (latest != null) {
                ...
                if (lastThroughputLabel != null) lastThroughputLabel.setText("N/A");
                if (lastCompressionRatioLabel != null) lastCompressionRatioLabel.setText("N/A");
                if (lastDurationLabel != null) lastDurationLabel.setText("N/A");
            }
            ...
            if (avgThroughputLabel != null) {
                ...
                if (avgThroughput > 0) {
                    ...
                    avgThroughputLabel.setText("N/A");
                }
            }
    ...
    private void updateSystemInfo() {
        ...
        // GPU info (potentially slow - already running in background thread)
        try {
